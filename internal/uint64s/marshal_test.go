...
import (
	...
	"github.com/reiver/go-cbor/internal/uint64s"
)
...
func TestMarshal(t *testing.T) {
	...
	tests := []struct{
...

		{
			...
			Expected: []byte{27,
				...
				byte( (4294967296 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
		...
		},
		{
			...
			Expected: []byte{27,
				...
				byte( (4294967297 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
		...
		},
		{
			...
			Expected: []byte{27,
				...
				byte( (4294967298 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
		...
		},
		{
			...
			Expected: []byte{27,
				...
				byte( (4294967299 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
		...
		},
		{
			...
			Expected: []byte{27,
				...
				byte( (4294967300 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
		...
		},
		{
			Value:         4294967301,
			Expected: []byte{27,
				byte( (4294967301 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (4294967301 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (4294967301 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (4294967301 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (4294967301 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (4294967301 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (4294967301 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (4294967301 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
...

		{
			Value:         5432198765,
			Expected: []byte{27,
				byte( (5432198765 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (5432198765 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (5432198765 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (5432198765 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (5432198765 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (5432198765 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (5432198765 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (5432198765 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
...

		{
			Value:         9876543219,
			Expected: []byte{27,
				byte( (9876543219 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (9876543219 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (9876543219 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (9876543219 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (9876543219 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (9876543219 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (9876543219 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (9876543219 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
...

		{
			Value:         98765432198,
			Expected: []byte{27,
				byte( (98765432198 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (98765432198 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (98765432198 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (98765432198 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (98765432198 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (98765432198 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (98765432198 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (98765432198 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
...

		{
			Value:         987654321987,
			Expected: []byte{27,
				byte( (987654321987 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (987654321987 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (987654321987 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (987654321987 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (987654321987 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (987654321987 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (987654321987 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (987654321987 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
...

		{
			Value:         9876543219876,
			Expected: []byte{27,
				byte( (9876543219876 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (9876543219876 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (9876543219876 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (9876543219876 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (9876543219876 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (9876543219876 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (9876543219876 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (9876543219876 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
		...
		{
			Value:         98765432198765,
			Expected: []byte{27,
				byte( (98765432198765 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (98765432198765 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (98765432198765 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (98765432198765 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (98765432198765 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (98765432198765 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (98765432198765 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (98765432198765 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
		...
		{
			Value:         987654321987654,
			Expected: []byte{27,
				byte( (987654321987654 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (987654321987654 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (987654321987654 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (987654321987654 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (987654321987654 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (987654321987654 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (987654321987654 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (987654321987654 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
		...
		{
			Value:         9876543219876543,
			Expected: []byte{27,
				byte( (9876543219876543 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (9876543219876543 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (9876543219876543 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (9876543219876543 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (9876543219876543 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (9876543219876543 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (9876543219876543 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (9876543219876543 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
		...
		{
			Value:         98765432198765432,
			Expected: []byte{27,
				byte( (98765432198765432 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (98765432198765432 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (98765432198765432 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (98765432198765432 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (98765432198765432 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (98765432198765432 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (98765432198765432 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (98765432198765432 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
...

		{
			...
			Expected: []byte{27,
				byte( (987654321987654321 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (987654321987654321 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (987654321987654321 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (987654321987654321 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (987654321987654321 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (987654321987654321 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (987654321987654321 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (987654321987654321 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
		...
		{
			Value:         9876543219876543219,
			Expected: []byte{27,
				byte( (9876543219876543219 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (9876543219876543219 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (9876543219876543219 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (9876543219876543219 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (9876543219876543219 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (9876543219876543219 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (9876543219876543219 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (9876543219876543219 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
...

		{
			...
			Expected: []byte{27,
				byte( (18446744073709551610 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (18446744073709551610 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (18446744073709551610 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (18446744073709551610 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (18446744073709551610 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (18446744073709551610 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (18446744073709551610 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (18446744073709551610 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
		{
			Value:         18446744073709551611,
			Expected: []byte{27,
				byte( (18446744073709551611 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (18446744073709551611 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (18446744073709551611 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (18446744073709551611 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (18446744073709551611 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (18446744073709551611 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (18446744073709551611 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (18446744073709551611 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
		{
			Value:         18446744073709551612,
			Expected: []byte{27,
				byte( (18446744073709551612 & 0xff_00_00_00_00_00_00_00) >> (8*7) ),
				byte( (18446744073709551612 & 0x00_ff_00_00_00_00_00_00) >> (8*6) ),
				byte( (18446744073709551612 & 0x00_00_ff_00_00_00_00_00) >> (8*5) ),
				byte( (18446744073709551612 & 0x00_00_00_ff_00_00_00_00) >> (8*4) ),
				byte( (18446744073709551612 & 0x00_00_00_00_ff_00_00_00) >> (8*3) ),
				byte( (18446744073709551612 & 0x00_00_00_00_00_ff_00_00) >> (8*2) ),
				byte( (18446744073709551612 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
				byte( (18446744073709551612 & 0x00_00_00_00_00_00_00_ff)          ),
			},
		},
		{
			...
			Expected: []byte{27,
				...
				byte( (18446744073709551613 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
		...
		},
		{
			...
			Expected: []byte{27,
				...
				byte( (18446744073709551614 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
		...
		},
		{
			...
			Expected: []byte{27,
				...
				byte( (18446744073709551615 & 0x00_00_00_00_00_00_ff_00) >> (8*1) ),
	...
	for testNumber, test := range tests {
		...
		actual, err := uint64s.Marshal(test.Value)

		if nil != err {
			t.Errorf("For test #%d, did not expect an error but actually got one.", testNumber)
			t.Logf("ERROR: (%T) %s", err, err)
			t.Logf("VALUE: %d (0x%02X) (%#064b)", test.Value, test.Value, test.Value)
			continue
		}
